...
#Aufgabe 4
"""Fuegen Sie zur der Gleichung x = 10/2/2/3+3*4**5/3/2/1-2 Klammern hinzu, 
die Gleichung einfacher zu Lesen ist"""
...
e= "1"	 #Man kann auch Zahlen in einen string umwandeln
e=1
f= e+1	#Wird nicht funktionieren, da man kein Wort mit einer Zahl addieren kann

#Aufgabe 6
"""Erstellen Sie eine Variable, mit dem namen 'satz' und weisen sie ihr den string
'Hello World' zu"""
...
#Aufgabe 8
"""Berechnen Sie x = 1*2**3+2-2*2-2 und geben Sie das Ergebniss in der Konsole 
aus
"""   
