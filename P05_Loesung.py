...
if "o" in sen:
    print ("Es gibt den Buchstaben 'o' in der Variablen 'sen'")
...
Zweiter Bonus fuer Pros: Verwenden Sie keine negativen Zahlen in dem Index.
"""
sen="Hallo World"
print(sen[0])
buchstaben=sen[0]
...
#Loesung
def last_letters(satz):
    last3=satz[-3:]
    return (last3)

satz_neu= input("Geben Sie was ein\n")
letzte3=last_letters(satz_neu)
print(letzte3)
#Aufgabe 6
"""
...
#Loesung
string_back= string[::-2]
print(string_back)
#alternativ
string_back= string[-1::-2]
print(string_back)
...
def print_string(satz):
    for ii in satz:
        print(ii)
        
print_string(eingabe)
...
jedes "l" mit dem Buchstaben "r". Am Ende gibt die Funktion
den neuen Satz mit den Aenderungen aus.
