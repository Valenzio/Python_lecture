...
"""Verwenden Sie das erstellte Dictionary aus Aufgabe 3. Legen Sie nun die 
zweite Note vom Studenten "Michi" in eine seperate Variable mit dem Namen 
"note_michi".Bonus Aufgabe: Speichern Sie die Durchschnittsnote von dem 
...
#Aufgabe 10:
""" Erweitern Sie die for-Schleife von Aufgabe 8 in dem der Name und die Note 
