...
def tank_berechnung(auto,strecke):
    ...
    verbrauch_liter= verbrauch * strecke/100
    tankfuellung = auto["tankfuellung"] - verbrauch_liter
    return(tankfuellung)
   
print (tank_berechnung(polo,500))
polo["tankfuellung"]= tank_berechnung(polo,500)
...
#Loesung
class Auto:
    def __init__(self,gewicht,leistung,tankinhalt,nummer):
...
passat = Auto(2200, 120, 60)

golf.tank_berechnung(100)
passat.tank_berechnung(150)
...
#Loesung
l_sum = l1 + l2 # elegante Weg
print(l_sum)
l_sum = l1.add(l2) # standard Weg
print(l_sum)

#Bonus
l_sum = Arrlist(l1 + l2)
print(l_sum)
print(Arrlist.add(l1,l2))
